...
export default class ProcedimientoValidator {
  ...
  public messages: CustomMessages = {
    ...
    'nombre.minLength': 'El nombre del procedimiento debe tener al menos 3 caracteres',
    'nombre.maxLength': 'El nombre del procedimiento no puede exceder los 50 caracteres',
    'nombre.regex': 'El nombre del procedimiento solo puede contener letras y espacios',
